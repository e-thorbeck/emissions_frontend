...
emissions_response = requests.get(emissions_endpoint)
...
col1.metric("Number of Buildings", response_analytics[selected_campus]['n_build'], "Buildings")
col2.metric("Total Square Feet", response_analytics[selected_campus]['total_sq_ft'], "Sq Feet")
col3.metric("Total Emissions", response_analytics[selected_campus]['years_of_emissions'], "kg of Co2")
